...
class Add_Product_management extends CI_Controller {
   ...
   public function index() {
      ...
      $data['allPdt'] = $this->am->view_data("product", "", "title", "asc");
      $data["page_title"] = "Add Product Management | nainai.com";
   ...
   public function insert() {
      ...
      if ($this->form_validation->run() == TRUE) {
         ...
         if ($this->am->save_data("add_product", $data)) {
   ...
   public function view() {
      $data = array();
      $data['page_title'] = "View Product | nainai.com";
   ...
   public function edit() {
      ...
      //print_r($data['selPdt']);
      $data["page_title"] = "Product Edit | nainai.com";
