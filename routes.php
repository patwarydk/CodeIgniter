 ...
 */
$route['default_controller'] = 'nainai';
$route['404_override'] = 'musfuq';
$route['translate_uri_dashes'] = FALSE;
...
foreach ($result as $value) {
   $route[RReplace($value->name) . '/details/(:num)'] = 'product/details/$1';
   $route[RReplace($value->name) . '/details/(:num)/(:any)'] = 'product/details/$1/$1';
}

function RReplace($data) {
